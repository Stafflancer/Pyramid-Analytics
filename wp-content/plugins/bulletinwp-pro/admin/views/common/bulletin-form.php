                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 class="arabic-font" dir="rtl" lang="ar" style="display: <?php echo ( strpos( $google_fonts, ' - Arabic' ) ) ? 'block' : 'none'; ?>;"><?php _e( 'هذه هي الطريقة التي سيبدو بها خط المحتوى!', BULLETINWP_PLUGIN_SLUG ) ?></h3>
                      <h3 class="hebrew-font" dir="rtl" lang="he" style="display: <?php echo ( strpos( $google_fonts, ' - Hebrew' ) ) ? 'block' : 'none'; ?>;"><?php _e( 'כך גופן התוכן הולך להיראות!', BULLETINWP_PLUGIN_SLUG ) ?></h3>
                    </div>
                  </div>
                </div>
              <?php endif; ?>
