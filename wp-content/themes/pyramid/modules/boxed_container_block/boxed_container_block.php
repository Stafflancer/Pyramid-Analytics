...
wp_enqueue_style('boxed_container_block', get_template_directory_uri() . '/static/css/modules/boxed_container_block/boxed_container_block.css', [], null);

if ($media_type == 'image' && !empty($image) && $parallax) {
	wp_enqueue_script('parallax-script');
}
?>
<section class="boxed_container_block
    <?php
