...
if ($s_heading || $s_content) {
	wp_enqueue_style('message_block_styles', get_template_directory_uri() . '/static/css/modules/message_block/message_block.css', [], null);
		...
		<div class="container">
			...
			<div class="section-holder">
				<?php if (!empty($s_heading)) { ?>
					<h2 class="wow slideInLeft"><?php echo $s_heading; ?></h2>
				<?php }
				if (!empty($s_content)) { ?>
